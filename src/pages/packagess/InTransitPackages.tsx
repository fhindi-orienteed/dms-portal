...
export default function InTransitPackages() {
    ...
    },
    {
      ...
      accessor: (pkg: Package) => (
        <span className="text-gray-500 text-theme-sm dark:text-gray-400">
          {pkg.shippingInfo.estimatedDelivery || "N/A"}
        </span>
      )
    },
  ];
  return (
    <>
      <PageMeta
        title="In Transit Packages | DMS Portal"
        description="In Transit Packages Dashboard"
      />
      <PageBreadcrumb pageTitle="In Transit Packages" />
      ...
      <div className="space-y-6">
        ...
        <GenericDataTable
          ...
          itemsPerPage={10}
          showPagination={true}
          emptyMessage="No in transit packages found."
