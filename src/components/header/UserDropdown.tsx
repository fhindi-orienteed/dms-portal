...
export default function UserDropdown() {
  ...
  const { displayName, photo, role, email } = profile;
  ...
  return (
    <div className='relative'>
      <button
        ...
        {photo ? <img src={photo} alt={displayName} /> : <UserIcon hanging={20} width={20} />}
      </button>
      ...
      <Dropdown
        ...
        <Button onClick={handleLogout}>
          <svg
            className='fill-white-500 group-hover:fill-gray-700 dark:group-hover:fill-gray-300'
            width='24'
            height='24'
            viewBox='0 0 24 24'
            fill='none'
