...
import { useTranslation } from "react-i18next"; // تأكد أنك تستخدم هذا أو الهُوك المناسب
    ...
    <div className="fixed inset-0 flex items-center justify-center overflow-y-auto z-99999">
      ...
      >
        {showCloseButton && (
          <button
            onClick={onClose}
            className={`absolute top-3 z-999 flex h-9.5 w-9.5 items-center justify-center rounded-full 
